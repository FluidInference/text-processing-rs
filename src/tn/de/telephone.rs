//! Telephone TN tagger for German.
//!
//! Converts written phone numbers to spoken German form:
//! - "030-1234-5678" -> "null drei null, eins zwei drei vier, fuenf sechs sieben acht"
//! - "+49-30-1234-5678" -> "plus vier neun, drei null, eins zwei drei vier, fuenf sechs sieben acht"
//! - "(030) 123-4567" -> "null drei null, eins zwei drei, vier fuenf sechs sieben"

/// Parse a written phone number to spoken German form.
...
/// Spell each digit in a group using German words.
...
mod tests {
    ...
    fn test_standard_phone() {
        assert_eq!(
            parse("030-1234-5678"),
            Some("null drei null, eins zwei drei vier, fuenf sechs sieben acht".to_string())
        );
    }
    ...
    fn test_with_country_code() {
        assert_eq!(
            parse("+49-30-1234-5678"),
            Some(
                "plus vier neun, drei null, eins zwei drei vier, fuenf sechs sieben acht"
                    .to_string()
            )
        );
    }
    ...
    fn test_parentheses() {
        assert_eq!(
            parse("(030) 123-4567"),
            Some("null drei null, eins zwei drei, vier fuenf sechs sieben".to_string())
        );
    }
    ...
    fn test_dots() {
        assert_eq!(
            parse("555.123.4567"),
            Some("fuenf fuenf fuenf, eins zwei drei, vier fuenf sechs sieben".to_string())
        );
    }
